...
class DiscoverMovie(PluginHandler):
    async def execute(self, credentials: BundleCredentials, plugin_input: PluginInput) -> PluginOutput:
        ...
        include_adult: bool = plugin_input.input_params.get("include_adult", False)
        ...
        base_url = f"https://api.themoviedb.org/3/discover/movie?api_key={tmdb_api_key}&include_adult={include_adult}&language={language}&page={page}&sort_by={sort_by}"
