...
class Text2ImageXl(PluginHandler):
    async def execute(self, credentials: BundleCredentials, plugin_input: PluginInput) -> PluginOutput:
        ...
        prompt_2: str = plugin_input.input_params.get("prompt_2", None)
        negative_prompt_2: str = plugin_input.input_params.get("negative_prompt_2", None)
        ...
        if negative_prompt_2:
            payload["negative_prompt_2"] = negative_prompt_2
        if width:
            payload["width"] = width
        if height:
