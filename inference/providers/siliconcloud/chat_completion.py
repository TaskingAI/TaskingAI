...
def _build_siliconcloud_message(message: ChatCompletionMessage):
    if message.role in [
...
def _build_siliconcloud_chat_completion_payload(
    ...
    formatted_messages = [_build_siliconcloud_message(msg) for msg in messages]
...
class SiliconcloudChatCompletionModel(BaseChatCompletionModel):
    ...
    def prepare_request(
        ...
        payload = _build_siliconcloud_chat_completion_payload(
